...
const formatNoteTitle = (title, description, category) => {
  ...
  return (
    <>
      ...
      <div className={`group bg-[#0F0F0F] relative border border-[#1f1f1f] ${PYQ_COLORS.borderClass} border-l-3 rounded-xl overflow-hidden hover:border-neutral-700 transition-all duration-300`}>
        {/* {note.recommended && (
  ...
  <div className="absolute -top-14 -right-10 -z-0 w-40 h-40 flex items-center justify-center overflow-visible">
    <div className="bg-cyan-600 text-white text-[10px] font-bold px-8 py-1 rotate-35 shadow-md whitespace-nowrap">
      ⭐ Recommended
    </div>
  </div>
)}
        ...
        >
          ...
          <div className="flex gap-2 pt-4">
            ...
            <Link
              ...
              className="flex-1 px-4 py-2.5 bg-[#1F1F1F] hover:bg-[#2F2F2F]  hover:opacity-90 text-white rounded-full font-semibold text-sm transition-all duration-200 flex items-center justify-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-neutral-700"
              onClick={() => {
